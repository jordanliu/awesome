...
| `convex-starter` | Monorepo starter template with convex, nextjs, better-auth, shadcn/ui, react-email and turborepo. | [Link](https://github.com/jordanliu/convex-starter)
